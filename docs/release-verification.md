...
|---|---|---|---|---|
| `grounding_dino_detection_colab.ipynb` (`E2E`) | pending | — | — | **PENDING** — no clean-runtime execution of the `E2E` blob has been recorded |
...
non-deterministic Hungarian training, not a finding.
